...
<div class="row">
    ...
    <form action="{{route('guardarcontrol')}}" method="post"> 
        ...
        <select  class="custom-select" name="idVeterin" id="" required>
        ...
        <select  class="custom-select" name="idMascota" id="" required>
        ...
        <input type="datetime-local" name="fecha" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
        <small id="helpId" class="text-muted">Por favor ingrese el fecha y hora del control. </small>
        <br>

        <label for="peso">Peso</label>
        <input type="number" name="peso" id="peso" class="form-control" placeholder="" aria-describedby="Helpps" required>
        <h6 id="Helpps" class="text-muted">Por favor ingrese el peso. </h6>
        <br>

        <label for="diagnos">Diagnóstico</label>
        <textarea class="form-control" id="" name="diagnos" rows="6" required>Escribe aquí el diagnóstico.</textarea>
        <small id="helpId" class="text-muted">Por favor ingrese el diagnóstico. </small>
        <br>
        <label for="trata">Tratamiento</label>
        <textarea class="form-control" id="" name="trata" rows="6" required>Escribe aquí el tratamiento.</textarea>
        <small id="helpId" class="text-muted">Por favor ingrese el tratamiento. </small>
        <br>
        <label for="observ">Observaciones</label>
        <textarea class="form-control" id="" name="observ" rows="6" required>Escribe aquí las observaciones.</textarea>
